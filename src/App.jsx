    ...
    const criteria = [
        ...
        },
        {
            ...
            question: "Rapid decline in renal function likely requiring dialysis in < 30 days?", category: 'Exclusion', failValue:
                true, reason: "Acute, rapid decline in renal function."
        }, {
            id: 'recent_treatment',
            question: "AMR/TCMR treatments (e.g. Rituximab, PLEX) within the last 3 months?", category: 'Exclusion',
            failValue: true, reason: "Recent AMR/TCMR treatment (washout period required)."
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex flex-col items-center p-3 sm:p-5 font-sans">
            <div className="max-w-4xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
                ...
                {/* Footer info */}
                <div
                    className="bg-slate-50 border-t border-slate-100 px-4 py-3 flex flex-col sm:flex-row justify-between items-center gap-2">
                    <p
